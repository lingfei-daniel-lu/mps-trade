...
* 1.1 Regressions of price change on monetary policy shocks
cd "D:\Project E"
...
* 1.2 Regression of quantity change on monetary policy shocks
cd "D:\Project E"
use sample_matched_exp,clear
...
* 1.3 Regression of trade credit on monetary policy shocks
