...
keep if cty_code==4280
collapse (sum) con_qy1_yr con_val_yr, by(commodity year)
save "D:\Project E\US_import\imp_Germany\imp_Germany_yearly_`i'n",replace
}

cd "D:\Project E\US_import\imp_Germany"
use imp_Germany_yearly_89n,clear
forv i=90/122{
append using imp_Germany_yearly_`i'n
}
...
save HS8_imp_Germany_89_22,replace

use HS8_imp_Germany_89_22,clear
gen HS6=substr(HS8,1,6)
collapse (sum) quantity=quantity value=value, by(year HS6)
gen HS2=substr(HS6,1,2)
gen price=value/quantity
save HS6_imp_Germany_89_22,replace

cd "D:\Project E\US_import\imp_Germany"
use HS6_imp_Germany_89_22,clear
...
save "D:\Project E\samples\US_import\HS6_imp_Germany_sample",replace
