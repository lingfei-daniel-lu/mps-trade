...
binscatter dlnprice brw, xtitle("Monetary policy shocks") ytitle("{&Delta} log price") savegraph("D:\Project E\figures\US_HS6_imp_brw_raw.png") replace nq(30)

binscatter dlnprice brw, control(dlnGDP dlndollar l.dlnprice) xtitle("Monetary policy shocks") ytitle("{&Delta} log price") savegraph("D:\Project E\figures\US_HS6_imp_brw_control.png") replace nq(30)
