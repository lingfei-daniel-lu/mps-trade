...
twoway (hist coefficient1, width(0.2) start(-0.2) frequency legend(off)) (scatteri 0 0 16 0,recast(line) lcolor(blue) lpattern(dash)) (scatteri 0 0.162 16 0.162, recast(line) lcolor(red) lpattern(solid) text(16 0.165 "China, 0.162", place(e) size(6)))
...
twoway (hist coefficient2, width(0.2) start(-0.2) frequency legend(off)) (scatteri 0 0 16 0,recast(line) lcolor(blue) lpattern(dash)) (scatteri 0 0.298 16 0.298, recast(line) lcolor(red) lpattern(solid) text(16 0.3 "China, 0.298", place(e) size(6)))
